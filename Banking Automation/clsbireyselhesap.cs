...
namespace Nesne1._0
{
    internal class clsbireyselhesap : Hesap
    {
        int miktar = BireyselParaYatir.miktar;
        int hesapno = BireyselParaYatir.hesapno;

        int miktarcek = BireyselParaCek.miktar;
        int hesapnocek = BireyselParaCek.hesapno;
        int toplam = BireyselParaCek.toplam;

        int miktarhav = BireyselHavale.miktar;
        int alıcıno = BireyselHavale.hesapnoal;
        int vericino = BireyselHavale.hesapnover;
        ...
        public override void ParaYatir()
        {
            ...
            using (NpgsqlDataReader oku = komut_yatır.ExecuteReader())
            {
                ...
                // Close the data reader before executing a new command
                oku.Close();
        ...
        public override void Havale()
        {
            ...
            using (NpgsqlDataReader oku = komut_cek.ExecuteReader())
            {
                if (oku.Read())
                {
                    ...
                    bakiye1 = bakiye1 - (miktarhav * 2 / 100);
